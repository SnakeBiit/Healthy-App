...
namespace Healthy.Data.Migrations
{
    ...
    [Migration("20210603192434_ultima")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Healthy.Data.Entities.Prescription", b =>
                {
                    ...
                    b.Property<int?>("PacientDoctorId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PacientDoctorId")
                        .IsUnique()
                        .HasFilter("[PacientDoctorId] IS NOT NULL");
            ...
            modelBuilder.Entity("Healthy.Data.Entities.Prescription", b =>
                {
                    b.HasOne("Healthy.Data.Entities.PacientDoctor", "PacientDoctor")
                        .WithOne("Prescription")
                        .HasForeignKey("Healthy.Data.Entities.Prescription", "PacientDoctorId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
